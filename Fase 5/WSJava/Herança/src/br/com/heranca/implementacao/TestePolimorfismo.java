...
public class TestePolimorfismo {
	...
	public static void main(String[] args) {
		...
		produto1.setTitulo(JOptionPane.showInputDialog("Digite o Titulo"));
		...
		CD produto2 = new CD();
		produto2.setTitulo(JOptionPane.showInputDialog("Digite o Titulo"));
		...
		System.out.println("Imposto do Livro (5%): R$ " + produto1.calcularImposto());
